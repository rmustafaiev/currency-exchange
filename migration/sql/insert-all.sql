...
INSERT INTO data_sources (base, name, description)
VALUES ('UAH', 'UDS', 'User defined data source. Exchange base currency=UAH.'),
	('UAH', 'NBU', 'National Bank Of Ukraine. Exchange base currency=UAH.'),
	('EUR', 'ECB', 'Europe Central Bank Bank. Exchange base currency=EUR.');


INSERT INTO currencies (code, num, name, region)
VALUES
    ...
    ('BND','96','Brunei Dollar','BRUNEI DARUSSALAM'),
    ('BOB','68','Boliviano','BOLIVIA'),
    ('BRL','986','Brazilian Real','BRAZIL'),
    ('BSD','44','Bahamian Dollar','BAHAMAS (THE)'),
    ('BTN','64','Bhutanese Ngultrum','BHUTAN'),
    ('BWP','72','Botswanan Pula','BOTSWANA'),
    ...
    ('KPW','408','North Korean Won','KOREA (THE DEMOCRATIC PEOPLES REPUBLIC OF)'),
    ...
    ('LAK','418','Laotian Kip','LAO PEOPLES DEMOCRATIC REPUBLIC (THE)'),
